...
public interface MockGroupService extends IService<MockGroup> {
     ...
     * @return
     */
    SimpleResult<List<ExportGroupVo>> toImportGroups(List<MultipartFile> files, MockGroupImportParamVo importVo);
     ...
     * @return
     */
    SimpleResult<MockGroup> copyMockGroup(MockGroup mockGroup, MockProject newProject);
     ...
     * @return
     */
    SimpleResult<MockGroup> moveMockGroup(MockGroup mockGroup, MockProject newProject);
