...
mock.label.mockGroupCount = 'Mock分组数量'
...
mock.label.todayError = '今日异常调用'
mock.label.trend7Days = '近7天调用趋势'
mock.label.projectActivity = '项目调用分布'
mock.label.projectDistribution = '项目属性占比'
mock.label.mockVsProxy = '返回类型分布'
mock.label.topIntercepted = '高频调用接口 Top 10'
mock.label.rank = '排名'
